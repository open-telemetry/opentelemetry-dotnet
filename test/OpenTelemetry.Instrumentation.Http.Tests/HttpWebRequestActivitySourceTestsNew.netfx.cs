// <copyright file="HttpWebRequestActivitySourceTestsNew.netfx.cs" company="OpenTelemetry Authors">
...
public class HttpWebRequestActivitySourceTestsNew : IDisposable
{
    ...
    static HttpWebRequestActivitySourceTestsNew()
    {
    ...
    public HttpWebRequestActivitySourceTestsNew()
    {
