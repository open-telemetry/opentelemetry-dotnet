...
{
    public partial class DiagnosticsHandlerTests : IDisposable
    {
        private readonly IDisposable serverLifeTime;
        private readonly string url;

        public DiagnosticsHandlerTests()
        {
...
#if NETFRAMEWORK
                        .AddHttpClientInstrumentation(null, o =>
#else
        ...
        public async Task HttpClientInstrumentationInjectsHeadersAsync_CustomFormat(bool shouldEnrich)
        {
            ...
            using (Sdk.CreateTracerProviderBuilder()
#if NETFRAMEWORK
                   .AddHttpClientInstrumentation(null, (opt) =>
#else
        ...
        public async Task HttpClientInstrumentationCorrelationAndBaggage()
        {
            ...
            using (Sdk.CreateTracerProviderBuilder()
#if NETFRAMEWORK
                .AddHttpClientInstrumentation(null, options => options.Enrich = ActivityEnrichment)
#else
        ...
        [Fact]
        public async Task DiagnosticsHandlerSkipedWhenHaveHttpClientHandler()
        {
            var processor = new Mock<BaseProcessor<Activity>>();
            var request = new HttpRequestMessage
            {
            ...
            using (Sdk.CreateTracerProviderBuilder()
#if NETFRAMEWORK
                .AddHttpClientInstrumentation(null, options => options.Filter = _ => throw new Exception())
#else
                .AddHttpClientInstrumentation()
#endif
                .AddProcessor(processor.Object)
                .Build())
            {
                using var c = new HttpClient(new DiagnosticsHandler { InnerHandler = new HttpClientHandler() });
                await c.SendAsync(request);
            }
