...
{
    public partial class DiagnosticsHandlerTests
    {
...
")));
        ...
        private static async Task CheckEnrichment(Sampler sampler, int expect)
        {
            ...
            using (Sdk.CreateTracerProviderBuilder()
                .SetSampler(sampler)
#if NETFRAMEWORK
                .AddHttpClientInstrumentation(null, options => options.Enrich = ActivityEnrichmentCounter)
#else
        ...
        private static HttpClient CreateHttpClient() =>
            new HttpClient(new DiagnosticsHandler
            {
#if NETFRAMEWORK
