...
namespace TestApp.AspNetCore._3._1
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.TryAddSingleton<TracerProviderSdk>(_ => TracerProviderSdk.Create(b => b
                    .AddRequestAdapter()
                    .AddDependencyAdapter()));
        }

        // This method gets called by the runtime. Use this method to configure the HTTP request pipeline.
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, TracerProviderSdk factory)
        {
