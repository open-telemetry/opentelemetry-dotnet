...
namespace OpenTelemetry.Exporter.Console.Tests.Simple;

public class SimpleLogRecordFormatterTests
{
    [Fact]
    public void FullIntegrationTest()
    {
        ...
        using var loggerFactory = LoggerFactory.Create(logging =>
            logging.AddOpenTelemetry(options =>
            {
                ...
                {
                    configure.Formatter = "simple";
                    configure.Console = mockConsole;
                });
            }));

        // Act
        var logger = loggerFactory.CreateLogger<SimpleLogRecordFormatterTests>();
