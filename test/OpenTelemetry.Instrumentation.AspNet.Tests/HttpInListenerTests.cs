...
namespace OpenTelemetry.Instrumentation.AspNet.Tests
{
    public class HttpInListenerTests : IDisposable
    {
        ...
        [InlineData("https://localhost:80/Home/Index.htm?q1=v1&q2=v2#FragmentName", "https://localhost:80/Home/Index.htm?q1=v1&q2=v2#FragmentName", 0, null, "TraceContext", "/Home/Index.htm")] // Test complex URL
        [InlineData("https://localhost:80/Home/Index.htm?q1=v1&q2=v2#FragmentName", "https://user:password@localhost:80/Home/Index.htm?q1=v1&q2=v2#FragmentName", 0, null, "TraceContext", "/Home/Index.htm")] // Test complex URL sanitization
        [InlineData("http://localhost:80/Index", "http://localhost:80/Index", 1, "{controller}/{action}/{id}", "TraceContext", "Index")]
        [InlineData("https://localhost:443/about_attr_route/10", "https://localhost:443/about_attr_route/10", 2, "about_attr_route/{customerId}", "TraceContext", "about_attr_route/{customerId}")]
        [InlineData("http://localhost:1880/api/weatherforecast", "http://localhost:1880/api/weatherforecast", 3, "api/{controller}/{id}", "TraceContext", "api/weatherforecast")]
        [InlineData("https://localhost:1843/subroute/10", "https://localhost:1843/subroute/10", 4, "subroute/{customerId}", "TraceContext", "subroute/{customerId}")]
        [InlineData("http://localhost/api/value", "http://localhost/api/value", 0, null, "TraceContext", "api/value", null, false, "/api/value")] // Request will be filtered
        [InlineData("http://localhost/api/value", "http://localhost/api/value", 0, null, "TraceContext", "api/value", null, false, "{ThrowException}")] // Filter user code will throw an exception
        [InlineData("http://localhost/api/value/2", "http://localhost/api/value/2", 3, "api/{controller}/{id}", "CustomContextMatchParent", "api/value/{id}", "value")]
        [InlineData("http://localhost/api/value/2", "http://localhost/api/value/2", 3, "api/{controller}/{id}", "CustomContextNonmatchParent", "api/value/{id}", "value")]
        [InlineData("http://localhost/api/value/2", "http://localhost/api/value/2", 3, "api/{controller}/{id}", "CustomContextNonmatchParent", "api/value/{id}", "value", false, null, true)]
