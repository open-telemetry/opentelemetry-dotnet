...
namespace OpenTelemetry.Exporter.Jaeger.Tests.Implementation
{
    ...
    using Xunit;
    using Process = Implimentation.Process;
    ...
    public class JaegerThriftIntegrationTest
    {
        ...
        {
            var validJaegerThriftPayload = Convert.FromBase64String("");
