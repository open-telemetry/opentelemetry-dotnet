...
namespace OpenTelemetry.Tags.Test
{
    public class TagTest
    {
        ...
        {
            Assert.Equal("k", Tag.Create("k", TagValue.Create("v")).Key);
        }

        [Fact]
        public void TestTagEquals()
        {
            var tag1 = Tag.Create("Key", TagValue.Create("foo"));
            var tag2 = Tag.Create("Key", TagValue.Create("foo"));
            var tag3 = Tag.Create("Key", TagValue.Create("bar"));
            var tag4 = Tag.Create("Key2", TagValue.Create("foo"));
