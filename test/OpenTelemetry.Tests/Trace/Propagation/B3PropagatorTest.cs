...
namespace OpenTelemetry.Context.Propagation.Tests
{
    public class B3PropagatorTest
    {
        ...
        public void Serialize_SampledContext()
        {
            ...
            this.b3propagator.Inject(new PropagationContext(new ActivityContext(TraceId, SpanId, TraceOptions), null), carrier, Setter);
        ...
        public void Serialize_NotSampledContext()
        {
            ...
            this.b3propagator.Inject(new PropagationContext(context, null), carrier, Setter);
        ...
        public void ParseMissingSampledAndMissingFlag()
        {
            ...
            Assert.Equal(new PropagationContext(spanContext, null), this.b3propagator.Extract(default, headersNotSampled, Getter));
        }
        ...
        public void ParseSampled()
        {
            ...
            Assert.Equal(new PropagationContext(activityContext, null), this.b3propagator.Extract(default, headersSampled, Getter));
        }
        ...
        public void ParseZeroSampled()
        {
            ...
            Assert.Equal(new PropagationContext(activityContext, null), this.b3propagator.Extract(default, headersNotSampled, Getter));
        }
        ...
        public void ParseFlag()
        {
            ...
            var activityContext = new ActivityContext(TraceId, SpanId, TraceOptions);
            Assert.Equal(new PropagationContext(activityContext, null), this.b3propagator.Extract(default, headersFlagSampled, Getter));
        }
        ...
        public void ParseZeroFlag()
        {
            ...
            var activityContext = new ActivityContext(TraceId, SpanId, ActivityTraceFlags.None);
            Assert.Equal(new PropagationContext(activityContext, null), this.b3propagator.Extract(default, headersFlagNotSampled, Getter));
        }
        ...
        public void ParseEightBytesTraceId()
        {
            ...
            Assert.Equal(new PropagationContext(activityContext, null), this.b3propagator.Extract(default, headersEightBytes, Getter));
        }
        ...
        public void Serialize_SampledContext_SingleHeader()
        {
            var carrier = new Dictionary<string, string>();
            var activityContext = new ActivityContext(TraceId, SpanId, TraceOptions);
            this.b3PropagatorSingleHeader.Inject(new PropagationContext(activityContext, null), carrier, Setter);
        ...
        public void ParseMissingSampledAndMissingFlag_SingleHeader()
        {
            ...
            var activityContext = new ActivityContext(TraceId, SpanId, ActivityTraceFlags.None);
            Assert.Equal(new PropagationContext(activityContext, null), this.b3PropagatorSingleHeader.Extract(default, headersNotSampled, Getter));
        }
        ...
        public void ParseFlag_SingleHeader()
        {
            ...
            var activityContext = new ActivityContext(TraceId, SpanId, TraceOptions);
            Assert.Equal(new PropagationContext(activityContext, null), this.b3PropagatorSingleHeader.Extract(default, headersFlagSampled, Getter));
        }
        ...
        public void ParseZeroFlag_SingleHeader()
        {
            ...
            var activityContext = new ActivityContext(TraceId, SpanId, ActivityTraceFlags.None);
            Assert.Equal(new PropagationContext(activityContext, null), this.b3PropagatorSingleHeader.Extract(default, headersFlagNotSampled, Getter));
        }
        ...
        public void ParseEightBytesTraceId_SingleHeader()
        {
            ...
            var activityContext = new ActivityContext(TraceIdEightBytes, SpanId, TraceOptions);
            Assert.Equal(new PropagationContext(activityContext, null), this.b3PropagatorSingleHeader.Extract(default, headersEightBytes, Getter));
        }
