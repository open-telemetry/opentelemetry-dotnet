...
namespace OpenTelemetry.Context.Propagation.Tests
{
    public class B3FormatTest
    {
        ...
        public void Serialize_SampledContext()
        {
            ...
            this.b3Format.Inject(new TextFormatContext(new ActivityContext(TraceId, SpanId, TraceOptions), null), carrier, Setter);
        ...
        public void Serialize_NotSampledContext()
        {
            ...
            this.b3Format.Inject(new TextFormatContext(context, null), carrier, Setter);
        ...
        public void ParseMissingSampledAndMissingFlag()
        {
            ...
            Assert.Equal(new TextFormatContext(spanContext, null), this.b3Format.Extract(default, headersNotSampled, Getter));
        }
        ...
        public void ParseSampled()
        {
            ...
            Assert.Equal(new TextFormatContext(activityContext, null), this.b3Format.Extract(default, headersSampled, Getter));
        }
        ...
        public void ParseZeroSampled()
        {
            ...
            Assert.Equal(new TextFormatContext(activityContext, null), this.b3Format.Extract(default, headersNotSampled, Getter));
        }
        ...
        public void ParseFlag()
        {
            ...
            var activityContext = new ActivityContext(TraceId, SpanId, TraceOptions);
            Assert.Equal(new TextFormatContext(activityContext, null), this.b3Format.Extract(default, headersFlagSampled, Getter));
        }
        ...
        public void ParseZeroFlag()
        {
            ...
            var activityContext = new ActivityContext(TraceId, SpanId, ActivityTraceFlags.None);
            Assert.Equal(new TextFormatContext(activityContext, null), this.b3Format.Extract(default, headersFlagNotSampled, Getter));
        }
        ...
        public void ParseEightBytesTraceId()
        {
            ...
            Assert.Equal(new TextFormatContext(activityContext, null), this.b3Format.Extract(default, headersEightBytes, Getter));
        }
        ...
        public void Serialize_SampledContext_SingleHeader()
        {
            var carrier = new Dictionary<string, string>();
            var activityContext = new ActivityContext(TraceId, SpanId, TraceOptions);
            this.b3FormatSingleHeader.Inject(new TextFormatContext(activityContext, null), carrier, Setter);
        ...
        public void ParseMissingSampledAndMissingFlag_SingleHeader()
        {
            ...
            var activityContext = new ActivityContext(TraceId, SpanId, ActivityTraceFlags.None);
            Assert.Equal(new TextFormatContext(activityContext, null), this.b3FormatSingleHeader.Extract(default, headersNotSampled, Getter));
        }
        ...
        public void ParseFlag_SingleHeader()
        {
            ...
            var activityContext = new ActivityContext(TraceId, SpanId, TraceOptions);
            Assert.Equal(new TextFormatContext(activityContext, null), this.b3FormatSingleHeader.Extract(default, headersFlagSampled, Getter));
        }
        ...
        public void ParseZeroFlag_SingleHeader()
        {
            ...
            var activityContext = new ActivityContext(TraceId, SpanId, ActivityTraceFlags.None);
            Assert.Equal(new TextFormatContext(activityContext, null), this.b3FormatSingleHeader.Extract(default, headersFlagNotSampled, Getter));
        }
        ...
        public void ParseEightBytesTraceId_SingleHeader()
        {
            ...
            var activityContext = new ActivityContext(TraceIdEightBytes, SpanId, TraceOptions);
            Assert.Equal(new TextFormatContext(activityContext, null), this.b3FormatSingleHeader.Extract(default, headersEightBytes, Getter));
        }
