...
public abstract class AggregatorTestsBase
{
    ...
    [InlineData("OpenTelemetry.Instrumentation.AspNetCore", "http.server.duration", "s", KnownHistogramBuckets.Default)]
    [InlineData("OpenTelemetry.Instrumentation.Http", "http.client.duration", "s", KnownHistogramBuckets.Default)]
