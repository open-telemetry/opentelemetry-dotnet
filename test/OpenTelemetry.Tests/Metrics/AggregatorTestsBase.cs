...
public abstract class AggregatorTestsBase
{
    ...
    [InlineData("OpenTelemetry.Instrumentation.AspNetCore", "http.server.duration", "s", KnownHistogramBuckets.DefaultShortSeconds)]
    [InlineData("OpenTelemetry.Instrumentation.Http", "http.client.duration", "s", KnownHistogramBuckets.DefaultShortSeconds)]
