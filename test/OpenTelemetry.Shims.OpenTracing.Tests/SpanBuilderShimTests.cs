...
namespace OpenTelemetry.Shims.OpenTracing.Tests
{
    ...
    public class SpanBuilderShimTests
    {
        ...
        public void IgnoreActiveSpan()
        {
            ...
            tracerMock.Verify(o => o.CreateRootSpan("foo", 0,
        ...
        public void StartWithExplicitTimestamp()
        {
            ...
            shim.Start();
            tracerMock.Verify(o => o.CreateSpan("foo", 0,
        ...
        public void AsChildOf_WithSpan()
        {
            ...
            tracerMock.Verify(o => o.CreateSpan("foo", span.Span, 0,
                default, It.Is<IEnumerable<Link>>(links => !links.Any())), Times.Once);
        }
        ...
        public void Start_ActivityOperationRootSpanChecks()
        {
            ...
            try
            {
                ...
                shim.Start();
                tracerMock.Verify(o => o.CreateSpanFromActivity("foo", activity, 0, It.Is<IEnumerable<Link>>(links => !links.Any())), Times.Once);
                ...
                shim.Start();
                tracerMock.Verify(o => o.CreateSpan("foo", 0, default, It.Is<IEnumerable<Link>>(links => !links.Any())), Times.Once);
            }
            finally
            {
                activity.Stop();
        ...
        public void AsChildOf_MultipleCallsWithSpan()
        {
            ...
            tracerMock.Verify(o => o.CreateSpan("foo", span1.Span, 0,
        ...
        public void AsChildOfWithSpanContext()
        {
            ...
            tracerMock.Verify(o => o.CreateSpan("foo", spanContext.SpanContext, 0,
                default, It.Is<IEnumerable<Link>>(links => !links.Any())), Times.Once);
        }
        ...
        public void AsChildOf_MultipleCallsWithSpanContext()
        {
            ...
            tracerMock.Verify(o => o.CreateSpan("foo", spanContext1.SpanContext, 0, 
        ...
        public void WithTag_KeyisSpanKindStringValue()
        {
            ...
            tracerMock.Verify(o => o.CreateSpan("foo", SpanKind.Client, default, It.Is<IEnumerable<Link>>(links => !links.Any())), Times.Once);
        }
        ...
        private static Mock<ITracer> GetDefaultTracerMock(SpanMock spanMock = null)
        {
            ...
            mock.Setup(x => x.CreateRootSpan(It.IsAny<string>(), It.IsAny<SpanKind>(), It.IsAny<DateTimeOffset>(), It.IsAny<IEnumerable<Link>>())).Returns(spanMock);
            mock.Setup(x => x.CreateSpan(It.IsAny<string>(), It.IsAny<SpanKind>(), It.IsAny<DateTimeOffset>(), It.IsAny<IEnumerable<Link>>())).Returns(spanMock);
            mock.Setup(x => x.CreateSpan(It.IsAny<string>(), It.IsAny<ISpan>(), It.IsAny<SpanKind>(), It.IsAny<DateTimeOffset>(), It.IsAny<IEnumerable<Link>>())).Returns(spanMock);
            mock.Setup(x => x.CreateSpan(It.IsAny<string>(), It.IsAny<SpanContext>(), It.IsAny<SpanKind>(), It.IsAny<DateTimeOffset>(), It.IsAny<IEnumerable<Link>>())).Returns(spanMock);
            mock.Setup(x => x.CreateSpanFromActivity(It.IsAny<string>(), It.IsAny<Activity>(), It.IsAny<SpanKind>(), It.IsAny<IEnumerable<Link>>())).Returns(spanMock);
            return mock;
        }
    }
}
