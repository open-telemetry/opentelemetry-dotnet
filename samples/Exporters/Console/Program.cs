...
namespace Samples
{
    ...
    public class Program
    {
        ...
        {
            Parser.Default.ParseArguments<JaegerOptions, ZipkinOptions, PrometheusOptions, HttpClientOptions, LightStepOptions, ZPagesOptions, ConsoleOptions, OtlpOptions>(args)
                .MapResult(
