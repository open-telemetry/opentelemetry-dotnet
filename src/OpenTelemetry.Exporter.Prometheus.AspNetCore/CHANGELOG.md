...
* For scrape requests with OpenMetrics format, otel_scope_info is automatically added ([#5086](https://github.com/open-telemetry/opentelemetry-dotnet/pull/5086))
