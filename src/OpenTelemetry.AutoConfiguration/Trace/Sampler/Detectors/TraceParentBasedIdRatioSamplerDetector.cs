// <copyright file="TraceParentBasedIdRatioSamplerDetector.cs" company="OpenTelemetry Authors">
...
internal sealed class TraceParentBasedIdRatioSamplerDetector : ITraceSamplerDetector
{
    ...
    public Sampler? Create(IServiceProvider serviceProvider, string optionsName, string? argument)
