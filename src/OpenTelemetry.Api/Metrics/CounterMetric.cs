...
namespace OpenTelemetry.Metrics
{
        ...
        where T : struct
    {
        ...
        public abstract void Add(in SpanReference spanReference, T value, LabelSet labelset);
        ...
        public abstract void Add(in SpanReference spanReference, T value, IEnumerable<KeyValuePair<string, string>> labels);
