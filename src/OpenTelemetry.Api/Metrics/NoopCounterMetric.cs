...
namespace OpenTelemetry.Metrics
{
        ...
        where T : struct
    {
        ...
        /// <inheritdoc/>
        public override void Add(in BaggageContext context, T value, LabelSet labelset)
        {
        }

        /// <inheritdoc/>
        public override void Add(in BaggageContext context, T value, IEnumerable<KeyValuePair<string, string>> labels)
        {
        }
