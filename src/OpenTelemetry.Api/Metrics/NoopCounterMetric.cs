...
namespace OpenTelemetry.Metrics
{
        ...
        where T : struct
    {
        ...
        /// <inheritdoc/>
        public override void Add(in SpanReference spanReference, T value, LabelSet labelset)
        {
        }

        /// <inheritdoc/>
        public override void Add(in SpanReference spanReference, T value, IEnumerable<KeyValuePair<string, string>> labels)
        {
        }
