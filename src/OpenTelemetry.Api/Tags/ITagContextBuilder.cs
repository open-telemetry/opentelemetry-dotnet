// <copyright file="ITagContextBuilder.cs" company="OpenTelemetry Authors">
...
namespace OpenTelemetry.Tags
{
    ...
    public interface ITagContextBuilder
    {
        ...
        ITagContextBuilder Put(string key, TagValue value);
        ...
        /// <returns>Tag context builder for operations chaining.</returns>
        ITagContextBuilder Remove(string key);
