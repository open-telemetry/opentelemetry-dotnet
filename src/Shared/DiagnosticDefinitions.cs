...
internal static class DiagnosticDefinitions
{
    ...
    public const string ObsoleteApiUrlFormat = "https://github.com/open-telemetry/opentelemetry-dotnet/tree/main/docs/diagnostics/obsolete-apis/README.md#{0}";
    ...
    public const string BaggageContextObsoleteApi = "OTEL2000";
}
