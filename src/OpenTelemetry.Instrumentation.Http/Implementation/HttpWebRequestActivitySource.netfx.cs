...
namespace OpenTelemetry.Instrumentation.Http.Implementation
{
    ...
    {
        public static readonly AssemblyName AssemblyName = typeof(HttpWebRequestActivitySource).Assembly.GetName();
        public static readonly string ActivitySourceName = AssemblyName.Name;
        public static readonly string ActivityName = ActivitySourceName + ".HttpRequestOut";
