...
namespace OpenTelemetry.Instrumentation.Http.Implementation
{
    ...
    internal static class HttpWebRequestActivitySource
    {
        ...
        internal static HttpWebRequestInstrumentationOptions Options = new();

        private static readonly Version Version = typeof(HttpWebRequestActivitySource).Assembly.GetName().Version;
        private static readonly ActivitySource WebRequestActivitySource = new(ActivitySourceName, Version.ToString());
