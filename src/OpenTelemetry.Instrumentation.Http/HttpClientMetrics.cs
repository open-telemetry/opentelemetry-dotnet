...
namespace OpenTelemetry.Instrumentation.Http
{
    ...
    internal sealed class HttpClientMetrics : IDisposable
    {
        ...
        /// </summary>
        /// <param name="options">Configuration options for HTTP client metrics instrumentation.</param>
        public HttpClientMetrics(HttpClientMetricsInstrumentationOptions options)
        {
