...
namespace OpenTelemetry.Adapter.Dependencies.Implementation
{
    internal class GrpcClientDiagnosticListener : ListenerHandler
    {
        ...
        public override void OnStartActivity(Activity activity, object payload)
        {
            ...
            {
                AdapterEventSource.Log.NullPayload(nameof(GrpcClientDiagnosticListener) + EventNameSuffix);
                return;
            }
        ...
        public override void OnStopActivity(Activity activity, object payload)
        {
            ...
            try
            {
                ...
                {
                    AdapterEventSource.Log.NullOrBlankSpan(nameof(GrpcClientDiagnosticListener) + EventNameSuffix);
                    return;
                }
