...
namespace OpenTelemetry.Logs
{
    ...
    public sealed class OpenTelemetryEventSourceLogEmitter : EventListener
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OpenTelemetryEventSourceLogEmitter"/> class.
        /// </summary>
        /// <param name="openTelemetryLoggerProvider"><see cref="OpenTelemetryLoggerProvider"/>.</param>
        /// <param name="name">Name of the <see cref="EventSource"/> to listen to.</param>
        /// <param name="logLevel">Event level to capture.</param>
        ...
        /// events should be captured for a given <see cref="EventSource"/>.
        /// Return <see langword="null"/> if no events should be
        /// captured.</param>
        public OpenTelemetryEventSourceLogEmitter(
            OpenTelemetryLoggerProvider openTelemetryLoggerProvider,
