...
///  [Body]".
/// </remarks>
internal sealed class SimpleLogRecordFormatter : SimpleFormatterBase<LogRecord>
{
    ...
    public SimpleLogRecordFormatter(ConsoleExporterOptions exporterOptions, SimpleFormatterOptions formatterOptions)
