...
namespace OpenTelemetry.Exporter.Jaeger.Implementation
{
    internal static class JaegerConversionExtensions
    {
        ...
        private static readonly EnumerationHelper<IEnumerable<KeyValuePair<string, object>>, TagState, KeyValuePair<string, object>>.ForEachDelegate ProcessAttributeRef = ProcessAttribute;
        private static readonly EnumerationHelper<IEnumerable<KeyValuePair<string, object>>, TagState, KeyValuePair<string, object>>.ForEachDelegate ProcessLibraryAttributeRef = ProcessLibraryAttribute;
        private static readonly EnumerationHelper<IEnumerable<Link>, PooledListState<JaegerSpanRef>, Link>.ForEachDelegate ProcessLinkRef = ProcessLink;
        private static readonly EnumerationHelper<IEnumerable<Event>, PooledListState<JaegerLog>, Event>.ForEachDelegate ProcessEventRef = ProcessEvent;
        private static readonly EnumerationHelper<IDictionary<string, object>, PooledListState<JaegerTag>, KeyValuePair<string, object>>.ForEachDelegate ProcessTagRef = ProcessTag;
        ...
        public static JaegerSpan ToJaegerSpan(this SpanData span)
        {
            ...
            EnumerationHelper<IEnumerable<KeyValuePair<string, object>>, TagState, KeyValuePair<string, object>>.AllocationFreeForEach(
                span.Attributes,
                ref jaegerTags,
                ProcessAttributeRef);
        ...
        public static PooledList<JaegerSpanRef> ToJaegerSpanRefs(this IEnumerable<Link> links)
        {
            ...
            EnumerationHelper<IEnumerable<Link>, PooledListState<JaegerSpanRef>, Link>.AllocationFreeForEach(
                links,
                ref references,
                ProcessLinkRef);
        ...
        public static PooledList<JaegerLog> ToJaegerLogs(this IEnumerable<Event> events)
        {
            ...
            EnumerationHelper<IEnumerable<Event>, PooledListState<JaegerLog>, Event>.AllocationFreeForEach(
                events,
                ref logs,
                ProcessEventRef);
        ...
        public static JaegerLog ToJaegerLog(this Event timedEvent)
        {
            ...
            EnumerationHelper<IDictionary<string, object>, PooledListState<JaegerTag>, KeyValuePair<string, object>>.AllocationFreeForEach(
