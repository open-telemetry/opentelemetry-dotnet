...
namespace OpenTelemetry.Trace
{
    ...
    public interface ITracer
    {
        ...
        /// <param name="linksProvider">Provider for the span Links.</param>
        /// <returns>Span instance.</returns>
        ISpan StartRootSpan(string operationName, SpanKind kind, DateTimeOffset startTimestamp, LinksProvider linksProvider);
        ...
        /// <param name="linksProvider">Provider for the span Links.</param>
        /// <returns>Span instance.</returns>
        ISpan StartSpan(string operationName, SpanKind kind, DateTimeOffset startTimestamp, LinksProvider linksProvider);
        ...
        /// <param name="linksProvider">Provider for the span Links.</param>
        /// <returns>Span instance.</returns>
        ISpan StartSpan(string operationName, ISpan parent, SpanKind kind, DateTimeOffset startTimestamp, LinksProvider linksProvider);
        ...
        /// <param name="linksProvider">Provider for the span Links.</param>
        /// <returns>Span instance.</returns>
        ISpan StartSpan(string operationName, in SpanContext parent, SpanKind kind, DateTimeOffset startTimestamp, LinksProvider linksProvider);
        ...
        /// <param name="linksProvider">Provider for the span Links.</param>
        /// <returns>Span instance.</returns>
        ISpan StartSpanFromActivity(string operationName, Activity activity, SpanKind kind, LinksProvider linksProvider);
    }
}
