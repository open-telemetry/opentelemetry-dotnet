...
public abstract class LoggerProviderBuilderBase : LoggerProviderBuilder, IDeferredLoggerProviderBuilder
{
    ...
    internal LoggerProviderBuilderBase(LoggerProviderBuilderState state)
    {
    ...
    protected LoggerProviderBuilderBase()
    {
    ...
    internal LoggerProviderBuilder AddExporter<T>(ExportProcessorType exportProcessorType, string? name, Action<ExportLogRecordProcessorOptions>? configure)
    ...
    internal LoggerProviderBuilder AddExporter(ExportProcessorType exportProcessorType, BaseExporter<LogRecord> exporter, string? name, Action<ExportLogRecordProcessorOptions>? configure)
    {
    ...
    internal LoggerProviderBuilder AddInstrumentation<T>(
    ...
    internal LoggerProviderBuilder AddProcessor(BaseProcessor<LogRecord> processor)
    {
    ...
    internal LoggerProviderBuilder AddProcessor<T>()
    ...
    internal LoggerProviderBuilder ConfigureResource(Action<ResourceBuilder> configure)
    {
        Guard.ThrowIfNull(configure);
    ...
    internal LoggerProviderBuilder ConfigureServices(Action<IServiceCollection> configure)
    {
        Guard.ThrowIfNull(configure);
    ...
    internal LoggerProvider InvokeBuild()
        => this.Build();

    internal LoggerProviderBuilder SetResourceBuilder(ResourceBuilder resourceBuilder)
    {
    ...
    /// <summary>
    /// Run the configured actions to initialize the <see cref="LoggerProvider"/>.
    /// </summary>
    /// <returns><see cref="LoggerProvider"/>.</returns>
    protected LoggerProvider Build()
    {
