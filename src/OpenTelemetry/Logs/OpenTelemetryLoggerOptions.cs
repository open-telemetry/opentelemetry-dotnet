...
namespace OpenTelemetry.Logs
{
    ...
    public class OpenTelemetryLoggerOptions
    {
        ...
        /// You should usually use <see cref="ConfigureResourceBuilder(Action{ResourceBuilder})"/> instead
        ...
        /// <returns>Returns <see cref="OpenTelemetryLoggerOptions"/> for chaining.</returns>
        public OpenTelemetryLoggerOptions ConfigureResourceBuilder(Action<ResourceBuilder> configure)
        {
