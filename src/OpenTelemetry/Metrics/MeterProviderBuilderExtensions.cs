...
namespace OpenTelemetry.Metrics
{
    ...
    public static class MeterProviderBuilderExtensions
    {
        ...
        /// You should usually use <see cref="ConfigureResourceBuilder(MeterProviderBuilder, Action{ResourceBuilder})"/> instead
        ...
        /// <returns>Returns <see cref="MeterProviderBuilder"/> for chaining.</returns>
        public static MeterProviderBuilder ConfigureResourceBuilder(this MeterProviderBuilder meterProviderBuilder, Action<ResourceBuilder> configure)
        {
