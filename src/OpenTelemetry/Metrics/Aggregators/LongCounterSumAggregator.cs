// <copyright file="LongCounterSumAggregator.cs" company="OpenTelemetry Authors">
...
namespace OpenTelemetry.Metrics.Aggregators
{
    ...
    /// </summary>
    public class LongCounterSumAggregator : Aggregator<long>
    {
        private long sum;
        ...
        public long ValueFromLastCheckpoint()
        {
