...
namespace OpenTelemetry.Metrics
{
    internal class DoubleCounterMetricSdk : CounterMetricSdkBase<double>
    {
        ...
        public override void Add(in SpanReference context, double value, LabelSet labelset)
        {
        ...
        public override void Add(in SpanReference context, double value, IEnumerable<KeyValuePair<string, string>> labels)
        {
            // user not using bound instrument. Hence create a short-lived bound instrument.
