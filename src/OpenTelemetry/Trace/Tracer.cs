...
namespace OpenTelemetry.Trace
{
    internal sealed class Tracer : ITracer
    {
        ...
        public ISpan StartRootSpan(string operationName, SpanKind kind, DateTimeOffset startTimestamp, LinksProvider linksProvider)
        {
            ...
            return Span.CreateRoot(operationName, kind, startTimestamp, linksProvider, this.tracerConfiguration, this.spanProcessor, this.LibraryResource);
        }

        /// <inheritdoc/>
        public ISpan StartSpan(string operationName, SpanKind kind, DateTimeOffset startTimestamp, LinksProvider linksProvider)
        {
            return this.StartSpan(operationName, null, kind, startTimestamp, linksProvider);
        }
        ...
        public ISpan StartSpan(string operationName, ISpan parent, SpanKind kind, DateTimeOffset startTimestamp, LinksProvider linksProvider)
        {
            ...
            return Span.CreateFromParentSpan(operationName, parent, kind, startTimestamp, linksProvider, this.tracerConfiguration,
        ...
        public ISpan StartSpan(string operationName, in SpanContext parent, SpanKind kind, DateTimeOffset startTimestamp, LinksProvider linksProvider)
        {
            ...
            if (parent != null)
            {
                return Span.CreateFromParentContext(operationName, parent, kind, startTimestamp, linksProvider, this.tracerConfiguration,
                    this.spanProcessor, this.LibraryResource);
            }

            return Span.CreateRoot(operationName, kind, startTimestamp, linksProvider, this.tracerConfiguration,
                this.spanProcessor, this.LibraryResource);
        }
        ...
        public ISpan StartSpanFromActivity(string operationName, Activity activity, SpanKind kind, LinksProvider linksProvider)
        {
            ...
            return Span.CreateFromActivity(operationName, activity, kind, linksProvider, this.tracerConfiguration, this.spanProcessor, this.LibraryResource);
        }
    }
}
