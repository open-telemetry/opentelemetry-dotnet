...
namespace OpenTelemetry.Trace
{
    ...
    public sealed class Span : ISpan
    {
                ...
                Resource libraryResource)
        {
            ...
            this.tracerConfigurationOptions = tracerConfigurationOptions;
        ...
        public void SetAttribute(KeyValuePair<string, object> keyValuePair)
        {
            ...
            lock (this.@lock)
            {
                ...
                {
                    this.attributes = new EvictingQueue<KeyValuePair<string, object>>(this.tracerConfigurationOptions.MaxNumberOfAttributes);
                }
        ...
        public void AddEvent(string name)
        {
            ...
            lock (this.@lock)
            {
                ...
                {
                    this.events =
                        new EvictingQueue<Event>(this.tracerConfigurationOptions.MaxNumberOfEvents);
                }
        ...
        public void AddLink(Link link)
        {
            ...
            lock (this.@lock)
            {
                ...
                if (this.links == null)
                {
                    this.links = new EvictingQueue<Link>(this.tracerConfigurationOptions.MaxNumberOfLinks);
                }
