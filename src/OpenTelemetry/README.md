...
[EventSource]([EventSource](https://docs.microsoft.com/dotnet/api/system.diagnostics.tracing.eventsource))
...
(i.e EventSources whole name starts with "OpenTelemetry-") will be written to a
log file.
