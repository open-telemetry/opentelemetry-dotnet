...
namespace OpenTelemetry.Exporter.ApplicationInsights
{
    ...
    public class ApplicationInsightsTraceExporter : SpanExporter, IDisposable
    {
        ...
        /// <inheritdoc/>
        public override Task<ExportResult> ExportAsync(IEnumerable<IReadableSpan> spanDataList, CancellationToken cancellationToken)
        {
        ...
        private void ExtractGenericProperties(IReadableSpan span,  out string name, out string resultCode, out string statusDescription, out string traceId, out string spanId, out string parentId, out bool? success, out TimeSpan duration)
        {
            name = span.Name;
