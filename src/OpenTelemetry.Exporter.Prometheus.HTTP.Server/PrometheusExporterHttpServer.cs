...
{
    public class PrometheusExporterHttpServer : BaseExporter<Metric>, IPullMetricExporter
    {
        ...
        public Func<int, bool> Collect { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
