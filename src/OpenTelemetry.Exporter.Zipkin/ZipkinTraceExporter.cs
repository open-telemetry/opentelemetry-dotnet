...
namespace OpenTelemetry.Exporter.Zipkin
{
    ...
    public class ZipkinTraceExporter : SpanExporter
    {
        ...
        /// <inheritdoc/>
        public override async Task<ExportResult> ExportAsync(IEnumerable<IReadableSpan> otelSpanList, CancellationToken cancellationToken)
        {
        ...
        internal ZipkinSpan GenerateSpan(IReadableSpan otelSpan, ZipkinEndpoint defaultLocalEndpoint)
        {
        ...
        private ZipkinSpanKind ToSpanKind(IReadableSpan otelSpan)
        {
