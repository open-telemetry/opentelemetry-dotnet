    ...
    static TraceServiceReflection() {
      ...
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, new pbr::GeneratedClrTypeInfo[] {
            ...
            new pbr::GeneratedClrTypeInfo(typeof(global::Opencensus.Proto.Agent.Trace.V1.ExportTraceServiceRequest), global::Opencensus.Proto.Agent.Trace.V1.ExportTraceServiceRequest.Parser, new[]{ "Node", "Spans", "Resource" }, null, null, null),
  ...
  public sealed partial class ExportTraceServiceRequest : pb::IMessage<ExportTraceServiceRequest> {
    ...
    public void MergeFrom(ExportTraceServiceRequest other) {
      ...
      if (other.resource_ != null) {
        if (resource_ == null) {
          resource_ = new global::Opencensus.Proto.Resource.V1.Resource();
        }
