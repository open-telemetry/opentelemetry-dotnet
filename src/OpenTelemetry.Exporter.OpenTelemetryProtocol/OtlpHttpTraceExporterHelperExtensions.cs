// <copyright file="OtlpHttpTraceExporterHelperExtensions.cs" company="OpenTelemetry Authors">
...
namespace OpenTelemetry.Trace
{
    ...
    public static class OtlpHttpTraceExporterHelperExtensions
    {
        ...
        public static TracerProviderBuilder AddOtlpHttpExporter(this TracerProviderBuilder builder, Action<OtlpExporterOptions> configure = null)
        {
            if (builder == null)
            {
            ...
            if (builder is IDeferredTracerProviderBuilder deferredTracerProviderBuilder)
            {
                ...
                {
                    AddOtlpHttpExporter(builder, sp.GetOptions<OtlpExporterOptions>(), configure);
                });
            }
        ...
        private static TracerProviderBuilder AddOtlpHttpExporter(TracerProviderBuilder builder, OtlpExporterOptions exporterOptions, Action<OtlpExporterOptions> configure = null)
        {
