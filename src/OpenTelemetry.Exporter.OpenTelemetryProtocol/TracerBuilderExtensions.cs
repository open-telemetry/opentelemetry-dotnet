...
namespace OpenTelemetry.Exporter.OpenTelemetryProtocol
{
    ...
    public static class TracerBuilderExtensions
    {
        ...
        public static TracerBuilder UseOpenTelemetryProtocol(this TracerBuilder builder, Action<ExporterOptions> configure)
        {
            if (builder == null)
            {
        ...
        /// <returns>The instance of <see cref="TracerBuilder"/> to chain the calls.</returns>
        public static TracerBuilder UseOpenTelemetryProtocol(
