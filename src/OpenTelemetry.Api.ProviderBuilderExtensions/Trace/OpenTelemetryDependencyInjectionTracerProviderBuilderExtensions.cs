...
public static class OpenTelemetryDependencyInjectionTracerProviderBuilderExtensions
{
    ...
    public static TracerProviderBuilder AddInstrumentation<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] T>(this TracerProviderBuilder tracerProviderBuilder)
        where T : class
    {
