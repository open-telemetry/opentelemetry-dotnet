...
public class Program
{
    ...
    public static void Main()
    {
        using var meterProvider = Sdk.CreateMeterProviderBuilder()
            ...
            .AddView(instrumentName: "MyHistogram", MetricStreamConfiguration.CreateHistogramConfiguration(new double[] { 10, 20 }))
            ...
            .AddView((instrument) =>
            {
                ...
                {
                    return MetricStreamConfiguration.CreateHistogramConfiguration(new double[] { 10, 20 });
                }
