    ...
    public class TraceBenchmark
    {
        ...
        public TraceBenchmark()
        {
            ...
            Sdk.CreateTracerProviderBuilder()
                .SetSampler(null)
                .AddActivitySource(this.sourceWithOneProcessor.Name)
                .AddProcessor(new DummyActivityProcessor())
                .Build();

            Sdk.CreateTracerProviderBuilder()
                .SetSampler(null)
                .AddActivitySource(this.sourceWithTwoProcessors.Name)
                .AddProcessor(new DummyActivityProcessor())
                .AddProcessor(new DummyActivityProcessor())
                .Build();
            ...
            Sdk.CreateTracerProviderBuilder()
                .SetSampler(null)
                .AddActivitySource(this.sourceWithThreeProcessors.Name)
                .AddProcessor(new DummyActivityProcessor())
                .AddProcessor(new DummyActivityProcessor())
                .AddProcessor(new DummyActivityProcessor())
                .Build();
